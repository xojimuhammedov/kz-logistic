                ...
                <Box className='container'>
                    ...
                    >
                        <Box maxW={{ base: "full", md: "50%" }}>
                            ...
                            <Link display={'flex'} alignItems={'center'} justifyContent={'center'} href='tel:+77710140505' w={'180px'} h={'54px'} bg="#F70" color="white" borderRadius={'12px'} _hover={{ bg: "orange.600" }}>
                                {t("ЗАПРОСИТЬ СЕЙЧАС")}
                            </Link>
                        </Box>
                        <Box>
